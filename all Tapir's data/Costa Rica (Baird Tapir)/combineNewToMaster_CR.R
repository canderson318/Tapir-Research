...
raw.new<- read.csv("WildID/Wild_ID_Kamuk_21/Wild_ID_Kamuk_21.csv", comment.char = "#")#note: csv has comments
master.old<- read.csv("Tapir Research/Code and Data/all Tapir's data/Costa Rica (Baird Tapir)/Master(5.31.22).csv", comment.char="#")
...
write.csv(Kamuk, "Tapir Research/Code and Data/all Tapir's data/Costa Rica (Baird Tapir)/Kamuk21-22_clean.csv", 
          row.names = FALSE)
...
#save combined df
write.csv(joined_df, 
          "Tapir Research/Code and Data/all Tapir's data/Costa Rica (Baird Tapir)/Master(2023-6-15).csv",
          row.names= FALSE)
