...
setwd("C:/Users/chris/Documents/Research/Tapir Reasearch/Code and Data")

#dataframe needs"lat", "lon", "date" (Y-M-D), and "hour" (H:M) column headers
#the function wants a 'species' column to work
baird.raw<- read.csv("all Tapir's data/Costa Rica (Baird Tapir)/Master(5.31.22).csv")
...
path<- "C:/Users/chris/Documents/Research/Tapir Research/Code and Data/all Tapir's data/Costa Rica (Baird Tapir)/bairdTemporalActivity/"
write.csv(sunData.baird, paste(path, "bairdSunDataIndependent.csv", sep=''), row.names = FALSE)
